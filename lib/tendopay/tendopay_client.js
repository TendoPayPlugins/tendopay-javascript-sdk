...
const PaymentResponse = require('./tendopay_payment_response').PaymentResponse;
...
class Client {
  ...
  async cancelTransaction ({ transactionNumber }) {
    let params = {
      [constants.params.transactionIdParam]: transactionNumber
    };
